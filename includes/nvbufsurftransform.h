...
typedef enum
{
  ...
  /** Specifies Open CV Nearest interpolation. */
  OPEN_CV_INTER_NEAREST,
  /** Specifies Open CV Linear interpolation. */
  OPEN_CV_INTER_LINEAR,
  /** Specifies Open CV Cubic interpolation. */
  OPEN_CV_INTER_CUBIC,
  /** Specifies Open CV Area interpolation. */
  OPEN_CV_INTER_AREA,
  /** Specifies Open CV Lanczos4 interpolation. */
  OPEN_CV_INTER_LANCZOS4,
  /** Specifies Open CV Max interpolation. */
  OPEN_CV_INTER_MAX,
  /** Specifies Open CV Fill Oulier interpolation. */
  OPEN_CV_WARP_FILL_OUTLIER,
  /** Specifies Open CV Inverse Map interpolation. */
  OPEN_CV_WARP_INVERSE_MAP,
